export const localeCodes = ["tc","en"]

export const localeMessages = {
}

export const additionalMessages = Object({"tc":[],"en":[],})
...
export const resolveNuxtI18nOptions = async (context) => {
 ...
 const vueI18nConfigLoader = async (loader) => {
  ...
  const vueI18n = await vueI18nConfigLoader((() => import("\u0000@nuxtjs/i18n/__config__?target=../i18n.config.ts&hash=4c8b999c" /* webpackChunkName: "i18n_config_4c8b999c" */)))
  nuxtI18nOptions.vueI18n = vueI18n
  nuxtI18nOptions.locales = ["tc","en"]
...
export const nuxtI18nInternalOptions = Object({__normalizedLocales: [Object({"code":"tc","iso":"tc"}),Object({"code":"en","iso":"en"})]})
