globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1 } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/radix3/dist/index.mjs';
import { generateJSON } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/@intlify/bundle-utils/index.mjs';
import { relative, join } from 'file:///Users/heisluffy/Desktop/nuxt3-test/node_modules/pathe/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/heisluffy/Desktop/nuxt3-test/server/assets"}];
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/heisluffy/Desktop/nuxt3-test/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/heisluffy/Desktop/nuxt3-test","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/heisluffy/Desktop/nuxt3-test/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/heisluffy/Desktop/nuxt3-test/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/heisluffy/Desktop/nuxt3-test/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _N6OtZE = defineEventHandler(async (event) => {
...
const _jFIS3L = defineEventHandler(async (event) => {
...
const _lazy_QghFb3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QghFb3, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _N6OtZE, lazy: false, middleware: false, method: "post" },
  { route: '/__i18n__/prerender/:hash', handler: _jFIS3L, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_QghFb3, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/heisluffy/Desktop/nuxt3-test/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/heisluffy/Desktop/nuxt3-test/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
